...
/**
 * Created by Iven on 2018/8/28-16:42
...
public class AndroidOPermissionActivity extends AppCompatActivity {
    ...
    private static  String  hint = "为了正常升级 xxx APP，请点击设置按钮，允许安装未知来源应用，本功能只限用于 xxx APP版本升级";

    public  static void setListenerHint(AppDownloadManager.AndroidOInstallPermissionListener listener,String hintStr){
        sListener = listener;
        hint = hintStr;
